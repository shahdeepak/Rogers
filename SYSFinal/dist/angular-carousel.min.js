                ...
                compile: function(m, n) {
                    ...
                    return ["ng-repeat", "data-ng-repeat", "ng:repeat", "x-ng-repeat"].every(function(a) {
                        ...
                        function(m, o, q, r) {
                            ...
                            function x(a, b) {
                                if (void 0 === a && (a = m.carouselIndex), b = b || {}, b.animate === !1 || "none" === L.transitionType) return T = !1, N = -100 * a, m.carouselIndex = a, void F();
                                T = !0;
                                var c = new j;
                                c.tween({
                                    from: {
                                    ...
                                    finish: function() {
                                        m.$apply(function() {
                                            m.carouselIndex = a, N = -100 * a, F(), f(function() {
                                                T = !1
                                            }, 0, !1)
                                        })
                                    }
                            ...
                            function A() {
                                S || (S = !0, c.bind("mouseup", v))
                            }

                            function B() {
                                S && (S = !1, c.unbind("mouseup", v))
                            }

                            function C(a, b) {
                                return T || P.length <= 1 ? void 0 : (z(), R = o[0].querySelector("li").getBoundingClientRect().left, H = !0, I = a.x, !1)
                            }

                            function D(a, b) {
                                var c, d;
                                if (A(), H && (c = a.x, d = I - c, d > 2 || -2 > d)) {
                                    O = !0;
                                    var e = N + 100 * -d / Q;
                                    w(e)
                                }
                            ...
                            function E(a, b, c) {
                                if ((!b || O) && (B(), H = !1, O = !1, J = I - a.x, 0 !== J && !T))
                                    if (N += 100 * -J / Q, L.isSequential) {
                                        var e = L.moveTreshold * Q,
                                            f = -J,
                                            g = -Math[f >= 0 ? "ceil" : "floor"](f / Q),
                                            h = Math.abs(f) > e;
                                        P && g + m.carouselIndex >= P.length && (g = P.length - 1 - m.carouselIndex), g + m.carouselIndex < 0 && (g = -m.carouselIndex);
                                        var i = h ? g : 0;
                                        J = m.carouselIndex + i, x(J), void 0 !== q.rnCarouselOnInfiniteScrollRight && 0 === g && 0 !== m.carouselIndex && (d(q.rnCarouselOnInfiniteScrollRight)(m), x(0)), void 0 !== q.rnCarouselOnInfiniteScrollLeft && 0 === g && 0 === m.carouselIndex && 0 === i && (d(q.rnCarouselOnInfiniteScrollLeft)(m), x(P.length))
                                    } else m.$apply(function() {
                                        m.carouselIndex = parseInt(-N / 100, 10), F()
                                    })
                            }
                            ...
                            function F() {
                                ...
                                t ? (a = m.carouselIndex <= b ? 0 : P && P.length < m.carouselBufferSize ? 0 : P && m.carouselIndex > P.length - m.carouselBufferSize ? P.length - m.carouselBufferSize : m.carouselIndex - b, m.carouselBufferIndex = a, f(function() {
                                    w(N)
                                }, 0, !1)) : f(function() {
                                    w(N)
                                }, 0, !1)
                            ...
                            "true" !== q.rnSwipeDisabled && a.bind(o, {
                                ...
                                b > P.length - 1 && (b = 0), T || x(b, a)
                            }, m.prevSlide = function(a) {
                                var b = m.carouselIndex - 1;
                                0 > b && (b = P.length - 1), x(b, a)
                            };
                            var U = !0;
                            if (m.carouselIndex = 0, s || (P = [], angular.forEach(u(), function(a, b) {
                                    P.push({
                                        id: b
                                    })
                            ...
                            if (q.rnCarouselIndex) {
                                ...
                                angular.isFunction(_.assign) ? (m.$watch("carouselIndex", function(a) {
                                    ...
                                    void 0 !== a && null !== a && (P && P.length > 0 && a >= P.length ? (a = P.length - 1, $(a)) : P && 0 > a && (a = 0, $(a)), T || x(a, {
                                        animate: !U
                                    }), U = !1)
                                }), M = !0, L.defaultIndex && x(L.defaultIndex, {
                                    animate: !U
                                })) : isNaN(q.rnCarouselIndex) || x(parseInt(q.rnCarouselIndex, 10), {
                                    animate: !1
                                })
                            } else x(L.defaultIndex, {
                                animate: !U
                            }), U = !1;
                            if (q.rnCarouselLocked && m.$watch(q.rnCarouselLocked, function(a, b) {
                                ...
                                m[aa ? "$watch" : "$watchCollection"](p, function(a, b) {
                                    if (P = a, !angular.isArray(P)) throw Error("the slides collection must be an Array");
                            ...
                            m.$on("$destroy", function() {
                                B()
                            }), m.carouselBufferIndex = 0, m.carouselBufferSize = L.bufferSize;
                            var ba = angular.element(b);
                            ba.bind("orientationchange", G), ba.bind("resize", G), m.$on("$destroy", function() {
                                B(), ba.unbind("orientationchange", G), ba.unbind("resize", G)
                            })
                        }
                }
            }
