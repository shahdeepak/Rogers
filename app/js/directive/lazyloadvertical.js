    ...
    function( $window, $document ) {
        ...
        var lazyLoader = (function() {
            ...
            function startWatchingWindow() {
                ...
                $("#scollgrid").on( "resize.verticalLazySrc", windowChanged );
                $("#scollgrid").on( "scroll.verticalLazySrc", windowChanged );
            ...
            function stopWatchingWindow() {
                ...
                $("#scollgrid").off( "resize.verticalLazySrc" );
                $("#scollgrid").off( "scroll.verticalLazySrc" );
