...
function InitOmniture(){
    ...
    s.account=RBI.omnitureConfig.omnitureAccount;
    /************************** CONFIG SECTION **************************/
    /* You may add or alter any code config here. */
    s.charSet=RBI.omnitureConfig.charSet;
    /* Conversion Config */
    s.currencyCode=RBI.omnitureConfig.currencyCode;
    /* Link Tracking Config */
    s.trackDownloadLinks=RBI.omnitureConfig.trackDownloadLinks;
    s.trackExternalLinks=RBI.omnitureConfig.trackExternalLinks;
    s.trackInlineStats=RBI.omnitureConfig.trackInlineStats;
    s.linkDownloadFileTypes=RBI.omnitureConfig.linkDownloadFileTypes;
    s.linkInternalFilters=RBI.omnitureConfig.linkInternalFilters; //optional: add your internal domain here
    s.linkLeaveQueryString=RBI.omnitureConfig.linkLeaveQueryString;
    s.linkTrackVars=RBI.omnitureConfig.linkTrackVars;
    s.linkTrackEvents=RBI.omnitureConfig.linkTrackEvents;

    /* WARNING: Changing any of the below variables will cause drastic
     changes to how your visitor data is collected.  Changes should only be
     made when instructed to do so by your account manager.*/
    s.trackingServer=RBI.omnitureConfig.trackingServer;
    s.extraSearchEngine=RBI.omnitureConfig.extraSearchEngine;
    s.channelDomain=RBI.omnitureConfig.channelDomain;
    s.channelPattern=RBI.omnitureConfig.channelPattern;
    return s;
}
