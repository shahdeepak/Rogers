...
(function (window) {
    ...
    Porthole.WindowProxy.getTargetWindow = function (targetWindowName) {
        if (targetWindowName === '') {
            if(typeof top.frames['s_parent'] !== "undefined") {
            	return top.frames['s_parent'];
            }
            else {
            	return top;
            }
        ...
        if (typeof parent.frames[targetWindowName] == "undefined") {
        	return  frames[targetWindowName];
        } else
            ...
            if (w) {
                for (i in w) {
                    if (w.hasOwnProperty(i)) {
                        try {
                            if (w[i] !== null && typeof w[i] === 'object' && w[i] instanceof w.window.Porthole.WindowProxy && w[i].getTargetWindowName() === sourceWindowName) {
                                return w[i];
                            }
                        } catch (e) {}
                    }
